...
public abstract class Requetes {
	...
	public static final String DATABASE_CREATE_ARTICLE = 
			"CREATE TABLE IF NOT EXISTS "+DATABASE_ARTICLE+" ( "
					+ DATABASE_ARTICLE_ID+" INTEGER NOT NULL,"
					+ DATABASE_ARTICLE_RUBRIQUE+" INTEGER DEFAULT NULL,"
					+ DATABASE_ARTICLE_AUTEUR+" TEXT DEFAULT NULL,"
					+ DATABASE_ARTICLE_TITREFR+" TEXT,"
					+ DATABASE_ARTICLE_TITREEN+" TEXT,"
					+ DATABASE_ARTICLE_CONTENUFR+" TEXT,"
					+ DATABASE_ARTICLE_CONTENUEN+" TEXT,"
					+ DATABASE_ARTICLE_AUTORISATIONCOM+" INT DEFAULT NULL,"
					+ DATABASE_ARTICLE_STATUT+" INT DEFAULT NULL,"
					+ DATABASE_ARTICLE_DATE+" STRING NOT NULL,"
					+ DATABASE_ARTICLE_PHOTO+" TEXT NOT NULL,"
					+ DATABASE_ARTICLE_VISIBLE+" INT NOT NULL DEFAULT '0',"
					+ "PRIMARY KEY ("+DATABASE_ARTICLE_ID+"),"
					//+ "KEY FK_ARTICLE_"+DATABASE_ARTICLE_RUBRIQUE+" ("+DATABASE_ARTICLE_RUBRIQUE+")"
