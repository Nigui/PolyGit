...
public class PersoClé extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		perso1 = DataBaseGetters.getParticipantsFromDBWithID(10);
		perso2 = DataBaseGetters.getParticipantsFromDBWithID(11);
		perso1Role = DataBaseGetters.getParticipationFromDBWithID(10);
		perso2Role = DataBaseGetters.getParticipationFromDBWithID(11);
